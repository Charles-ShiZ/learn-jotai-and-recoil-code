...
console.log(nodes, recoilValues)
...
var HashArrayMappedTrieMap = class {
  ...
  get(k) {
    console.log('this._hamt', this._hamt)
...
function RecoilRoot_INTERNAL({
  ...
  */
  ...
  storeStateRef = Recoil_useRefInitOnce(() => initializeState_DEPRECATED != null ? initialStoreState_DEPRECATED(storeRef.current, initializeState_DEPRECATED) : initializeState != null ? initialStoreState(initializeState) : { ...makeEmptyStoreState$2(), appName: children.type.name });
...
function useRecoilValueLoadable_LEGACY(recoilValue) {
  ...
  const getLoadable = useCallback$1(() => {
    ...
    const treeState = reactMode$3().early
      ? (_storeState$nextTree5 = storeState.nextTree) !== null && _storeState$nextTree5 !== void 0
...
function useSetRecoilState(recoilState) {
  ...
  return useCallback$1((newValueOrUpdater) => {
    console.log('storeRef.current', storeRef.current.getState())
    setRecoilValue$2(storeRef.current, recoilState, newValueOrUpdater);
